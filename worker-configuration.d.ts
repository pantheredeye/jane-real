/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7cd59e72029eacc8d52c1d1a766ca1de)
// Runtime types generated with workerd@1.20251109.0 2025-08-21 no_handle_cross_request_promise_resolution,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "SessionDurableObject" | "AgentStateDO";
	}
	interface Env {
		WEBAUTHN_APP_NAME: "routefast" | "routefast-staging";
		VAPID_PUBLIC_KEY: "";
		VAPID_PRIVATE_KEY: "";
		VAPID_SUBJECT: "mailto:admin@routefast.app";
		DIGEST_FROM_EMAIL: "reminders@routefast.app";
		...
		FREE_CREDITS_AMOUNT: string;
		STRIPE_PUBLISHABLE_KEY: string;
		SESSION_DURABLE_OBJECT: DurableObjectNamespace<import("./src/worker").SessionDurableObject>;
		AGENT_STATE_DO: DurableObjectNamespace<import("./src/worker").AgentStateDO>;
		DB: D1Database;
		AI: Ai;
		ASSETS: Fetcher;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WEBAUTHN_APP_NAME" | "VAPID_PUBLIC_KEY" | "VAPID_PRIVATE_KEY" | "VAPID_SUBJECT" | "DIGEST_FROM_EMAIL" | "WEBAUTHN_RP_ID" | "AUTH_SECRET_KEY" | "GOOGLE_MAPS_API_KEY_SERVER" | "DATABASE_URL" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_SECRET" | "FREE_CREDITS_AMOUNT" | "STRIPE_PUBLISHABLE_KEY">> {}
}
