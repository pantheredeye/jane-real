-- Production Migration: Add Credits System
-- Apply Date: 2025-11-27
-- Description: Adds credits system with tracking (creditsRemaining, totalCreditsGranted, UsageLog table)

-- Add credits fields to User table
